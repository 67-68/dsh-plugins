...
dsh-plugins 是 DeepSeek Harness（DSH）整套配置的真理源 git 仓库：plugins/packages/presets/preset-actions/profile/document 为部署源，install.sh 幂等同步到 ~/.dsh，feature_intents 为唯一规范的需求意图目录。

---

## 2026-09-23T06:13:13.033Z
